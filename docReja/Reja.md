...
| Subtask | Work Item | Estimate |
|---------|-----------|----------|
| 9.5.1 | **ExamsMonthFilter** — horizontal scroll, 12 oylik tab (Jan–Dec), aktiv oy highlight (navy) | 1h |
...
*Total fazalar: 19 | Taxminiy umumiy effort: ~500h*
*Canonical execution plan v4 — talimy.space*
