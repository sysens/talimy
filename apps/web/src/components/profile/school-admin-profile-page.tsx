          ...
          {settings ? (
            <>
              <div className="grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:grid-cols-2">
                <InfoRow label={t("adminNameLabel")} value={settings.fullName} />
                <InfoRow label={t("adminEmailLabel")} value={settings.email} />
                <InfoRow label={t("schoolLabel")} value={settings.tenantName} />
                <InfoRow
                  label={t("schoolPolicyLabel")}
                  value={resolvePolicyDescription(t, settings.tenantGenderPolicy)}
                />
              </div>
